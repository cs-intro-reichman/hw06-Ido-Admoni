...
public class Editor4 {
	...
	private static void morphToGrayscale(Color[][] sourceImage, int n) { // creating morph with grayscled image
        for (int i = 0; i < n; i++) {
            double alpha = (double) (n - i) / n;
            Color[][] morphedImage = Runigram.blend(sourceImage, Runigram.grayScaled(sourceImage), alpha);
